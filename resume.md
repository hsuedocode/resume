...
- **Other**: Git, AWS EC2/ECS/S3/Lambda/SQS/DynamoDB, Docker, Kubernetes, TDD
...
- Collaborated with both customers and vendors to resolve bugs and provide support for design decisions.
